...
def format_signal(signal: TradingSignal) -> str:
    ...
    return (
        ...
        f"  Current Price : ${signal.entry_price:>16,.6f}\n"
...
def send_signal(signal: TradingSignal) -> None:
    ...
    logger.info(
        ...
        signal.symbol, signal.ai_action, signal.confidence, signal.pump_score,
    )
...
{CYAN}{'═'*60}{RESET}
  ⚠️  DISCLAIMER: This tool provides analysis ONLY.
